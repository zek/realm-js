...
/**
 * Sets all privileges to the given state.
 *
 * @param permission {Realm.Permissions.Permission} permission to modify.
 * @param state {boolean} state of a
 */
function setAllPrivileges(permission, state) {
    permission.canCreate = state;
    permission.canRead = state;
    permission.canUpdate = state;
    permission.canDelete = state;
    permission.canQuery = state;
    permission.canModifySchema = state;
    permission.canSetPermissions = state;
}
...
module.exports = function(realmConstructor) {
    ...
    if (realmConstructor.Sync) {
        ...
        Permission.prototype.enableAllPrivileges = function() {
            setAllPrivileges(this, true);
        };
        Permission.prototype.disableAllPrivileges = function() {
            setAllPrivileges(this, false);
        };
